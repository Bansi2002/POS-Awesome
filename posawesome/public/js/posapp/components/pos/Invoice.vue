                ...
                <v-row class="ma-0 pa-0">
                  ...
                  <v-col cols="4">
                    <v-text-field dense outlined color="primary" :label="frappe._('Available QTY')"
                      background-color="white" hide-details :value="item.actual_qty" disabled></v-text-field>
                  </v-col>
                  <v-col cols="4">
        ...
        <v-col cols="7">
          <v-row no-gutters class="pa-1 pt-9 pr-1">
            <v-col cols="6" class="pa-1">
              <v-text-field :value="total_qty" :label="frappe._('Total Qty')" outlined dense readonly hide-details
